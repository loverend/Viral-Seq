This directory contains code written by Lauren Overend (lauren.overend@oriel.ox.ac.uk) 
to run viral read detection on bulk RNA sequencing data (either paired or unpaired). 
This is an adapation of the single cell tool Viral Track. 

Submission should be done like this: 
...
-t 1:2 = number of samples from sample sheet, e.g you could run just sample 1 with qsub -1 t or you could run 1-100 with qsub -t 1:100
