...
CMD="Rscript /well/immune-rep/shared/CODE/Viral-Seq/BulkRNA/ViRNAseq_Unique.R -f ${SAMPLE1} -k ${SAMPLE2} -n 2 -o ${OUTPUTDIR} -p ${PAIRED}"
fi 

if [[ "${PAIRED}" == "FALSE" ]]; then
echo "Running script for SINGLE end reads"
CMD="Rscript /well/immune-rep/shared/CODE/Viral-Seq/BulkRNA/ViRNAseq_Unique.R -f ${SAMPLE1} -n 2 -o ${OUTPUTDIR} -p ${PAIRED}"
fi
